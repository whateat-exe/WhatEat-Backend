...
public final class ActivateFood {
    ...
    public static final class ActivateFoodController extends AbstractController {
        ...
        @ApiResponse(
                description = "Failed activating food.",
                responseCode = "400s/500s",
                content = @Content(schema = @Schema(implementation = WhatEatErrorResponse.class))
        )
        public ResponseEntity<Object> activateFood(@PathVariable Tsid id) {
            service.activate(id);
    ...
    @AllArgsConstructor
    public static class ActivateFoodService {
        ...
        public void activate(Tsid id) {
            ...
            final Food food = foodRepository.findByIdWithParent(whatEatId)
                    .orElseThrow(() -> WhatEatException.builder()
                            ...
                            .build());
            if (food.getStatus() == ActiveStatus.ACTIVE) {
