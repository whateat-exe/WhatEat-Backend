...
public final class GetPostsByCurrentUser {

    @Getter
    @Setter
    public static final class GetPostsByCurrentUserRequest extends PaginationRequest {
    }
    ...
    public static final class GetPostsByCurrentUserController extends AbstractController {

        private final GetPostsByCurrentUserService getPostsService;
        ...
        public ResponseEntity<Object> getPosts(@ParameterObject GetPostsByCurrentUserRequest getPostsRequest) {
    ...
    public static class GetPostsByCurrentUserService {
        ...
        public PostsResponse getPosts(GetPostsByCurrentUserRequest getPostsRequest) {
